...
exports.promisifyCordova = undefined;

var _es6Promise = require('es6-promise');

var promisifyCordova = function promisifyCordova(pluginObj, pluginName, methodName) {
  return function () {
...
var PluginConfig = exports.PluginConfig = [{
  id: 'device',
  className: 'Device',
...
},{}],"cordova-wrap":[function(require,module,exports){
'use strict';
...
function newPluginClass(config) {
  var obj = {
    ...
    plugin: function plugin() {
      return (0, _util.get)(window, config.pluginRef);
    },
...
for (var i = 0; i < _pluginConfig.PluginConfig.length; i++) {
  var plugin = _pluginConfig.PluginConfig[i];
  ...
  for (var j = 0; j < promised.length; j++) {
    ...
    var p = (0, _cordova.promisifyCordova)(cls, plugin.id, method);
    cls[method] = p;
  }
...
},{"./cordova":3,"./plugin-config":4,"./util":5}]},{},["cordova-wrap"]);

//# sourceMappingURL=cordova-wrap.js.map
