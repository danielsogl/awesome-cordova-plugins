...
exports.clear = function (callback, scope) {
    this.myvoidfunction('clearBadge', null, callback, scope);
};
...
exports.set = function (badge, callback, scope) {
    ...
    this.registerPermission(function (granted) {
        if (granted) {
            this.myvoidfunction('setBadge', args, callback, scope);
        }
    }, this);
};
...
exports.get = function (callback, scope) {
    this.myvoidfunction('getBadge', null, callback, scope);
};
...
exports.hasPermission = function (callback, scope) {
    this.myvoidfunction('hasPermission', null, callback, scope);
};
...
exports.registerPermission = function (callback, scope) {
    this.myvoidfunction('registerPermission', null, callback, scope);
};
...
exports.exec = function (action, args, callback, scope) {
    ...
    myvoidfunction(fn, null, 'Badge', action, params);
};
