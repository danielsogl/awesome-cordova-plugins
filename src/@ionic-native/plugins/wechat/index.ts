...
@Plugin({
  ...
  repo: 'https://github.com/xu-li/cordova-plugin-wechat.git', // the github repository URL for the plugin
  ...
  installVariables: ['wechatappid'], // OPTIONAL the plugin requires variables
