...
export function wrapInstance(pluginObj: any, methodName: string, opts: any = {}) { // tslint:disable-line
  return (...args) => {
    if (opts.sync) {
 ...
 * does just this.
 */
export function overrideFunction(pluginObj: any, methodName: string, args: any[], opts: any = {}): Observable<any> { // tslint:disable-line
  return new Observable(observer => {
