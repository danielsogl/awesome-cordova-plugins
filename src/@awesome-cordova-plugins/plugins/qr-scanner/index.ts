...
/**
 * @name QRScanner Plugin
 * @description
 * Cordova QR Scanner Plugin
 * @usage
 * ```typescript
...
export class QRScanner extends AwesomeCordovaNativePlugin {
   ...
   *
   * @return {Promise<QRScannerStatus>} return QRScannerStatus
   */
  @Cordova()
   ...
   *
   * @returns {Promise<QRScannerStatus>} return QRScannerStatus
   */
  @Cordova()
   ...
   *
   * @param {number} camera Provide `0` for back camera, and `1` for front camera.
   * @return {Promise<QRScannerStatus>} return QRScannerStatus
   */
  @Cordova()
