 ...
 * @usage
 * ```typescript
 * import { SolaariBle } from '@awesome-cordova-plugins/solaari-ble';
 *
 *
 * constructor(private solaariBle: SolaariBle) { }
 *
 * ...
 *
 *
 * this.solaariBle.functionName('Hello', 123)
...
export class SolaariBle extends AwesomeCordovaNativePlugin {
  ...
  /**
   * @name addService
   * Add a service with characteristics. If more than one service is added, add them sequentially
   * @param serviceUUID
